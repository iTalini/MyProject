...
// End Cross Module References
	DEFINE_FUNCTION(AMyProjectProjectile::execInitVelocity)
	{
		P_GET_STRUCT_REF(FVector,Z_Param_Out_ShootDirection);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->InitVelocity(Z_Param_Out_ShootDirection);
		P_NATIVE_END;
	}
	...
	void AMyProjectProjectile::StaticRegisterNativesAMyProjectProjectile()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "InitVelocity", &AMyProjectProjectile::execInitVelocity },
			{ "OnHit", &AMyProjectProjectile::execOnHit },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics
	{
		struct MyProjectProjectile_eventInitVelocity_Parms
		{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::NewProp_ShootDirection_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::NewProp_ShootDirection = { "ShootDirection", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MyProjectProjectile_eventInitVelocity_Parms, ShootDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::NewProp_ShootDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::NewProp_ShootDirection_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::NewProp_ShootDirection,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::Function_MetaDataParams[] = {
		{ "Comment", "/** inits velocity of the projectile in the shoot direction */" },
		{ "ModuleRelativePath", "MyProjectProjectile.h" },
		{ "ToolTip", "inits velocity of the projectile in the shoot direction" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMyProjectProjectile, nullptr, "InitVelocity", nullptr, nullptr, sizeof(MyProjectProjectile_eventInitVelocity_Parms), Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04C20401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AMyProjectProjectile_InitVelocity()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AMyProjectProjectile_InitVelocity_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AMyProjectProjectile_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AMyProjectProjectile_InitVelocity, "InitVelocity" }, // 2081446778
		{ &Z_Construct_UFunction_AMyProjectProjectile_OnHit, "OnHit" }, // 4233738714
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyProjectProjectile, 2740647501);
